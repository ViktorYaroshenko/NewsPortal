...
from news.models import Post, Category, Subscriptions
...
def my_job():
    ...
    email_of_subscribers = set(Subscriptions.objects.filter(category_id__in=categories).values_list('user__email', flat=True))
